...
export default function ClimateDataSourcesGuide() {
    return (
        <article className="bg-slate-950 px-4 py-12">
            <div className="mx-auto max-w-3xl">
                {/* Breadcrumb */}
                <nav className="mb-8 text-sm">
                    <Link href="/guides" className="text-slate-400 hover:text-emerald-400">
                        Guides
                    </Link>
                    <span className="mx-2 text-slate-600">/</span>
                    <span className="text-slate-300">Climate Data Sources</span>
                </nav>
                ...
                <div className="prose prose-invert prose-emerald max-w-none">
                    ...
                    <h2 className="text-2xl font-bold text-white">1. World Bank Climate Data</h2>

                    <h3 className="text-xl font-semibold text-emerald-400">Overview</h3>
                    <p className="text-slate-300">
                    ...
                    <h3 className="text-xl font-semibold text-emerald-400">Key Indicators</h3>
                    ...
                    <h3 className="text-xl font-semibold text-emerald-400">Cons</h3>
                    <ul className="space-y-1 text-slate-300">
                    ...
                    <h2 className="text-2xl font-bold text-white">2. Climate Watch</h2>
                    ...
                    <h3 className="text-xl font-semibold text-emerald-400">Key Data Types</h3>
                    <ul className="space-y-2 text-slate-300">
                    ...
                    <h2 className="text-2xl font-bold text-white">3. NASA POWER</h2>
                    ...
                    <h3 className="text-xl font-semibold text-emerald-400">Key Parameters</h3>
                    <ul className="space-y-2 text-slate-300">
                    ...
                    <h2 className="text-2xl font-bold text-white">4. NOAA Climate Data</h2>
                    ...
                    <h3 className="text-xl font-semibold text-emerald-400">Key Datasets</h3>
                    <ul className="space-y-2 text-slate-300">
                    ...
                    <p className="text-sm text-slate-500 mt-2">Note: Requires free API token from NOAA</p>
                    ...
                    <h2 className="text-2xl font-bold text-white">5. IMF Climate Data</h2>
                    ...
                    <h2 className="text-2xl font-bold text-white">Best Practices for Using Climate Data</h2>

                    <h3 className="text-xl font-semibold text-emerald-400">1. Validate Data Sources</h3>
                    <p className="text-slate-300">
                    ...
                    <h3 className="text-xl font-semibold text-emerald-400">2. Handle Data Gaps</h3>
                    <p className="text-slate-300">
                    ...
                    <h3 className="text-xl font-semibold text-emerald-400">3. Understand Update Frequencies</h3>
                    <p className="text-slate-300">
                    ...
                    <h3 className="text-xl font-semibold text-emerald-400">4. Cross-Reference Sources</h3>
                    <p className="text-slate-300">
                ...
                {/* CTA */}
                <div className="mt-12 rounded-xl border border-emerald-600 bg-emerald-950/30 p-8 text-center">
