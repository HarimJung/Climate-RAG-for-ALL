        ...
        <article className="bg-slate-950 px-4 py-12">
            <div className="mx-auto max-w-3xl">
                ...
                <nav className="mb-8 text-sm">
                    ...
                    <span className="text-slate-300">ISSB S2 Beginners</span>
                </nav>
                ...
                <div className="prose prose-invert prose-emerald max-w-none">
                    <h2 className="text-2xl font-bold text-white">What is IFRS S2?</h2>
                    ...
                    <h2 className="text-2xl font-bold text-white">The Four Pillars of IFRS S2</h2>

                    <h3 className="text-xl font-semibold text-emerald-400">1. Governance</h3>
                    <p className="text-slate-300">
                    ...
                    <h3 className="text-xl font-semibold text-emerald-400">2. Strategy</h3>
                    <p className="text-slate-300">
                    ...
                    <h3 className="text-xl font-semibold text-emerald-400">3. Risk Management</h3>
                    <p className="text-slate-300">
                    ...
                    <h3 className="text-xl font-semibold text-emerald-400">4. Metrics and Targets</h3>
                    <p className="text-slate-300">
                    ...
                    <h2 className="text-2xl font-bold text-white">Getting Started: A 5-Step Approach</h2>

                    <h3 className="text-xl font-semibold text-emerald-400">Step 1: Assess Materiality</h3>
                    <p className="text-slate-300">
                    ...
                    <h3 className="text-xl font-semibold text-emerald-400">Step 2: Calculate Your Carbon Footprint</h3>
                    <p className="text-slate-300">
                    ...
                    <h3 className="text-xl font-semibold text-emerald-400">Step 3: Map Your Governance</h3>
                    <p className="text-slate-300">
                        Document how climate oversight is structured in your organization. Identify gaps and assign clear responsibilities.
                    </p>

                    <h3 className="text-xl font-semibold text-emerald-400">Step 4: Conduct Scenario Analysis</h3>
                    <p className="text-slate-300">
                    ...
                    <h3 className="text-xl font-semibold text-emerald-400">Step 5: Set Targets and Disclose</h3>
                    <p className="text-slate-300">
